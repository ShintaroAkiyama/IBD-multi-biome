...
Lyso <- ggbetweenstats(plot.type = "box", data = vOTU_input, x = Group, y = "Sum of abundance (Lysogenic)", type = "nonparametirc", title = "", centrality.plotting = FALSE, ggplot.component = list(theme(text=element_text(size=20)), scale_x_discrete(limits=c("Controls", "UC", "CD"))), results.subtitle = FALSE, centrality.point.args = list(size = 4, color = "darkred"), centrality.label.args = list(size = 4, nudge_x = 0.5, segment.linetype = 2, min.segment.length = 0), ggsignif.args = list(textsize = 6, tip_length = 0.01))
Gen<-ggbetweenstats(plot.type = "box", data = vOTU_input, x = Group, y = "Sum of abundance (Generalist)", type = "nonparametirc", title = "", centrality.plotting = FALSE, ggplot.component = list(theme(text=element_text(size=20)), scale_x_discrete(limits=c("Controls", "UC", "CD"))), results.subtitle = FALSE, centrality.point.args = list(size = 4, color = "darkred"), centrality.label.args = list(size = 4, nudge_x = 0.5, segment.linetype = 2, min.segment.length = 0), ggsignif.args = list(textsize = 6, tip_length = 0.01))
Spe<-ggbetweenstats(plot.type = "box", data = vOTU_input, x = Group, y = "Sum of abundance (Specialist)", type = "nonparametirc", title = "", centrality.plotting = FALSE, ggplot.component = list(theme(text=element_text(size=20)), scale_x_discrete(limits=c("Controls", "UC", "CD"))), results.subtitle = FALSE, centrality.point.args = list(size = 4, color = "darkred"), centrality.label.args = list(size = 4, nudge_x = 0.5, segment.linetype = 2, min.segment.length = 0), ggsignif.args = list(textsize = 6, tip_length = 0.01))
