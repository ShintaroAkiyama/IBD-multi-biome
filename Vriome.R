...
Legend_list <- list(`Blautia` = list(title = "Predicted host (genus)", at = c("infect", "not infect"), labels = c("YES", "NO")))
...
ra3 = rowAnnotation(df=annotation_species, col = list('Ruminococcus' = col_species, `Blautia` = col_species, `Bacteroides` = col_species,`Streptococcus` = col_species,`Faecalibacterium` = col_species, `Clostridium` = col_species, `Eubacterium` = col_species, `Coprococcus` = col_species, `Roseburia` = col_species, `Parabacteroides` = col_species, `Fusicatenibacter` = col_species, 
                                                      `Porphyromonas` = col_species, `Unclassified Firmicutes` = col_species, `Lactobacillus` = col_species, `Anaerostipes` = col_species, `Dorea` = col_species, `Unclassified Lachnospiraceae` = col_species, `Alistipes` = col_species, `Bifidobacterium` = col_species, `Anaerotruncus` = col_species, `Bacillus` = col_species,`Prevotella` = col_species,
                                                      `Akkermansia` = col_species,`Collinsella` = col_species,`Eggerthella` = col_species,`Escherichia` = col_species,`Flavonifractor` = col_species,`Gemmiger` = col_species,`Lachnoclostridium` = col_species, `Odoribacter` = col_species,`Petroclostridium` = col_species,`Tyzzerella` = col_species,`Unclassified Clostridia` = col_species,
                                                      `Unclassified Clostridiales` = col_species,'Shigella'= col_species, 'Achromobacter'=col_species, 'Senegalimassilia'=col_species,'Veillonella'=col_species, 'Others'= col_species), gp = gpar(col = "black"), simple_anno_size = unit(2, "mm"),  annotation_name_gp= gpar(fontsize = 7),  
                    show_legend = c(FALSE, TRUE,FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,FALSE, FALSE, FALSE, FALSE, FALSE,FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE,FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE), annotation_legend_param = Legend_list)　
