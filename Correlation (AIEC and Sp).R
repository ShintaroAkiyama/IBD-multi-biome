...
KO_ra <- HeatmapAnnotation("UC" = anno_simple(K_p$"Coefficient (UC JP)", col = m_col_fun, pch = pch2,  simple_anno_size = unit(3, "mm"), gp = gpar(col = "black")), 
                           "CD" = anno_simple(K_p$"Coefficient (CD JP)", col = m_col_fun, pch = pch3,  simple_anno_size = unit(3, "mm"), gp = gpar(col = "black")), 
